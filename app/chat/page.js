...
export default function page() {
  return (
    <div className="w-[100%] h-[86vh] bg-[#222327]   rounded-[20px] overflow-hidden ">
          ...
          <div className="w-[100%]  min-h-[100vh] flex flex-col gap-1 relative">
            <div className="flex px-[1rem] gap-3 items-center justify-center ">
              <div className="flex gap-8 items-center justify-center  w-[100%]">
                <div className="w-[100%] h-[40vh] bg-[#0e0e0e] rounded-[30px] flex flex-col gap-4 justify-center px-[1rem]">
                  ...
                  <p className="px-[7px] text-[14px] py-[10px] bg-[#1e1f20] rounded-[20px] flex justify-center items-center w-[90%]">
                    advancements in technology
                  </p>
                  <p className="px-[7px] text-[14px] py-[10px] bg-[#1e1f20] rounded-[20px] flex justify-center items-center w-[70%]">
                    debug python code{" "}
                  </p>
                  <p className="px-[7px] text-[14px] py-[10px] bg-[#1e1f20] rounded-[20px] flex justify-center items-center w-[60%]">
                    how something works
                  </p>
                </div>
                <div className="w-[100%] h-[40vh] bg-[#0e0e0e] rounded-[30px] flex flex-col gap-4 justify-center px-[1rem]">
                  <h2 className="text-[25px] text-3xl font-[500] bg-gradient-to-r from-purple-500 via-red-600 to-blue-500 bg-clip-text text-transparent">
                    Create
                  </h2>
                  <p className="px-[7px] text-[14px] py-[10px] bg-[#1e1f20] rounded-[20px] flex justify-center items-center w-[90%]">
