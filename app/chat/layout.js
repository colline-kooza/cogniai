...
/>
        ...
        <div className="flex">
          ...
          <div className="flex flex-col md:w-[100%] w-[100%] lg:w-[74%] bg-black lg:h-[85vh] rounded-[1rem]">
            <main className="min-h-full overflow-hidden w-[100%]">
              {children}
            </main>
            <div className="lg:w-[74%] md:w-[100%] w-[100%] h-[18vh] md:h-[14vh] lg:h-[18vh] bg-[#1e1f20]  fixed bottom-0 md:bottom-3 lg:bottom-3 rounded-b-[1px] md:rounded-b-[39px] lg:rounded-b-[39px] overflow-hidden z-50">
              <SearchForm />
            </div>
          </div>
        </div>
